...
CREATE TABLE IF NOT EXISTS `lesson` (
  ...
  `chapter_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `grammar` (
  ...
  `title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `language_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `grammar_section` (
  ...
  `title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `grammar_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `lesson_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `level_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `course_progress` (
  ...
  KEY `FK9skkrx5h3gi1i8tyw7mxw9ndk` (`language_id`),
  KEY `FKbadjigldffbqgm3xjbxy4m46b` (`user_id`),
  CONSTRAINT `FK9skkrx5h3gi1i8tyw7mxw9ndk` FOREIGN KEY (`language_id`) REFERENCES `language` (`language_id`),
...
CREATE TABLE IF NOT EXISTS `question_ordering` (
  ...
  PRIMARY KEY (`question_id`),
  CONSTRAINT `FKqc7gnp6yd9j7ac53450rw4jws` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `question_progress` (
  ...
  `user_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKgg5sylc9xmgqbl7gd3mdufk9k` (`question_id`),
  KEY `FKgab9hvli19sh0rxhj5k95e3wy` (`user_id`),
  CONSTRAINT `FKgab9hvli19sh0rxhj5k95e3wy` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `FKgg5sylc9xmgqbl7gd3mdufk9k` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `question_true_false` (
  ...
  `question_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`question_id`),
  CONSTRAINT `FKtfw8wladoeatnqbmuce72r7s4` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `question_fill_blank` (
  `question_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `question_matching` (
  `question_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`question_id`),
  CONSTRAINT `FK4376y2mw11s2let70ykk04j2r` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=UTF8MB4_GENERAL_CI;
...
CREATE TABLE IF NOT EXISTS `matching_pair` (
  ...
  `part_text` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `question_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
